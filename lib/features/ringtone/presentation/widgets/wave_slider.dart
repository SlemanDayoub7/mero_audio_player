...
class WaveSlider extends StatefulWidget {
  ...
  const WaveSlider({
    ...
    this.wavActiveColor = Colors.grey,
    this.wavDeactiveColor = Colors.grey,
...
class WaveSliderState extends State<WaveSlider> {
  ...
  Widget build(BuildContext context) {
    ...
    final double progressPosition =
        (widthSlider / widget.duration) * widget.currentProgress;
            ...
            Expanded(
              child: Container(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    // مؤشر التقدم الحالي حسب الوقت (دائرة صغيرة أو خط عمودي)
                    Row(
                    ...
                    if (progressPosition >= _getBarStartPosition() &&
                        progressPosition <= _getBarEndPosition())
                      Positioned(
                        left: progressPosition,
                        top: 0,
                        bottom: 0,
                        child: Container(width: 10, color: Colors.red),
                      ),
                    Bar(
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          width: width,
          child: Icon(Icons.menu, size: 12, color: Colors.white),
        ),
      ),
    );
  }
