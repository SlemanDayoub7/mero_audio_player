...
class EqualizerUi extends StatefulWidget {
  const EqualizerUi({Key? key}) : super(key: key);

  @override
  State<EqualizerUi> createState() => _EqualizerUiState();
}

class _EqualizerUiState extends State<EqualizerUi> {
  @override
  void initState() {
    super.initState();
  }
