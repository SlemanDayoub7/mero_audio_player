                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          /// شريط علوي (رجوع + اسم الفنان + صورة صغيرة)
                          SizedBox(
                            height: 0.1.sh,
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                ...
                                globalBackgroundImagePath == null
                                    ...
                                    : Container(
                                      ...
                                      child: RotatingWhilePlayingWidget(
                                        player: player,
                          ...
                          /// Artwork كبير في الوسط إذا ما في خلفية
                          if (globalBackgroundImagePath == null)
                            Container(
                              height: 0.3.sh,
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                              ...
                              ControlIconWidget(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder:
                                          (_) => CreateAudiobookPage(
                                            audioFile: audioBloc.state.current!,
                                          ),
                                    ),
                                  );
                                },
                                svgGenImage: Assets.icons.cut,
                              ),
